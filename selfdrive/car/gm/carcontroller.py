...
PADDLE_STEER_GAP_MIN_NS = 10_000_000   # ≥5 ms each side (EPS guard)
PADDLE_STEER_GAP_MAX_NS = 12_000_000  # cap for long intervals
PADDLE_GAP_TARGET_NS    = 10_000_000   # aim per‑side gap even if interval//2 − early is larger
PADDLE_NONBLOCK_GAP_NS  = 2_000_000   # ≥1 ms since last paddle send
